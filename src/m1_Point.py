...
class Point(object):
    ...
    def __init__(self, x, y):
        """ Init gives values to thet instance variables."""
        self.x = x
        self.y = y
        self.moves_made = 0
        self.start_x = x
    ...
    def move_to(self, x, y):
        ...
        self.distance_traveled = self.distance_traveled + distance(self, destination)
        self.x = x
        self.y = y
        self.moves_made = self.moves_made + 1

    def move_by(self, dx, dy):
        destination = Point(self.x+dx,self.y+dy)
        self.distance_traveled = self.distance_traveled + distance(self, destination)
        self.x = self.x + dx
        self.y = self.y + dy
        self.moves_made = self.moves_made + 1
    ...
    def get_distance_from_start(self):
        ...
        return distance(self, start)

    def get_distance_traveled(self):
        return self.distance_traveled

    def closer_to(self, p2, p3):
        if distance(self, p2) <= distance(self, p3):
            return p2
        else:
            return p3
...
# Helper. I put it outside of the class, because main() might want
# to use it directly as well. It could have gone inside.
def distance(p1, p2):
